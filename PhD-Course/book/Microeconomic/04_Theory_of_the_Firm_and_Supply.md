...
<div style="width:100%;max-width:1120px;margin:0 auto;">
  <iframe src="./production-set-assumptions.html" title="Production Set Assumptions" loading="lazy" style="width:100%;height:1120px;border:0;display:block;border-radius:16px;"></iframe>
</div>
```
