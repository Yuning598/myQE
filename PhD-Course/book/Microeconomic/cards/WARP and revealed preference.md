...
type: card
topic: WARP
tags: [micro, consumer-theory, revealed-preference]
orphan: true
---
...
$$
x\ \text{chosen when }y\text{ available}
\quad\Rightarrow\quad
y\text{ cannot later defeat }x.
$$

QE trigger: when the question gives finite choice data and asks whether it can be rationalized.
