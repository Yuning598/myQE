...
\underbrace{W_i}_{\text{terminal wealth}}
=
\underbrace{M_i}_{\text{risk-free position}}
+
\underbrace{X_i v}_{\text{payoff from risky asset holdings}}

$$
在交易时买入 $X_i$ 单位风险资产需要支付 $X_i p$，而初始财富为 $m_i$，所以预算约束是
$$

\underbrace{M_i}_{\text{cash left in risk-free asset}}
+
\underbrace{X_i p}_{\text{expenditure on risky asset}}
=
\underbrace{m_i}_{\text{initial wealth}}
...
\underbrace{m_i}_{\text{initial wealth}}
+
\underbrace{(v-p)}_{\text{net payoff per unit of risky asset}}
\underbrace{X_i}_{\text{risky asset holdings}}.
...
关联卡片：[CARA-Normal framework](Asset Pricing/Theoretical AP/cards/CARA-Normal framework - 均值方差等价与最优需求)
...
相关卡片：[Asset Pricing/Theoretical AP/cards/Grossman-Stiglitz - 信息价值与支付意愿](Asset Pricing/Theoretical AP/cards/Grossman-Stiglitz - 信息价值与支付意愿)

**说明：- 点击展开：信息价值与支付意愿**
![[Asset Pricing/Theoretical AP/cards/Grossman-Stiglitz - 信息价值与支付意愿#核心推导]]
...
完整推导整理为卡片：[GS Exercise](Asset Pricing/Theoretical AP/cards/Grossman-Stiglitz Exercise 1 - 价格系数求解)。

**说明：- 点击展开：Exercise 1 完整推导**
![[Asset Pricing/Theoretical AP/cards/Grossman-Stiglitz Exercise 1 - 价格系数求解#目标|GS Exercise 1 - 目标]]
...
线性均衡的完整推导：[线性定价与线性交易](Asset Pricing/Theoretical AP/cards/Kyle 线性均衡猜测 - 线性定价与线性交易)。
...
完整推导整理为卡片：[Kyle Exercise 2](Asset Pricing/Theoretical AP/cards/Kyle Exercise 2 - 两期利润比较与解释)。

**说明：- 点击展开：Exercise 2 完整推导**
![[Asset Pricing/Theoretical AP/cards/Kyle Exercise 2 - 两期利润比较与解释#目标|Kyle Exercise 2 - 目标]]
...
相关卡片：[Asset Pricing/Theoretical AP/cards/Back 1992 - 净订单流 SDE](Asset Pricing/Theoretical AP/cards/Back 1992 - 净订单流 SDE) · [Asset Pricing/Theoretical AP/cards/Kalman-Bucy - 一般公式](Asset Pricing/Theoretical AP/cards/Kalman-Bucy - 一般公式)

**说明：- 点击展开：净订单流 SDE / Kalman-Bucy 一般公式**
![[Asset Pricing/Theoretical AP/cards/Back 1992 - 净订单流 SDE#核心推导]]
![[Asset Pricing/Theoretical AP/cards/Kalman-Bucy - 一般公式#核心公式]]
...
相关卡片：[Asset Pricing/Theoretical AP/cards/Back 1992 - HJB 分解](Asset Pricing/Theoretical AP/cards/Back 1992 - HJB 分解)

**说明：- 点击展开：HJB 分解卡片**
![[Asset Pricing/Theoretical AP/cards/Back 1992 - HJB 分解#核心推导]]
...
相关卡片：[Asset Pricing/Theoretical AP/cards/Back 1992 - 验证定理](Asset Pricing/Theoretical AP/cards/Back 1992 - 验证定理)

**说明：- 点击展开：验证定理卡片**
![[Asset Pricing/Theoretical AP/cards/Back 1992 - 验证定理#核心推导]]
...
相关卡片：[Asset Pricing/Theoretical AP/cards/Back 模型 - 相关扩展](Asset Pricing/Theoretical AP/cards/Back 模型 - 相关扩展)

**说明：- 点击展开：Back 模型的相关扩展**
![[Asset Pricing/Theoretical AP/cards/Back 模型 - 相关扩展#核心内容]]
...
相关卡片：[Asset Pricing/Theoretical AP/cards/Back 1992 - 对数正态终值练习](Asset Pricing/Theoretical AP/cards/Back 1992 - 对数正态终值练习)

**说明：- 点击展开：对数正态终值练习**
![[Asset Pricing/Theoretical AP/cards/Back 1992 - 对数正态终值练习#核心推导]]
...
相关卡片：[Asset Pricing/Theoretical AP/cards/正态-正态更新 - 常数漂移学习](Asset Pricing/Theoretical AP/cards/正态-正态更新 - 常数漂移学习)

**说明：- 点击展开：正态-正态更新卡片**
![[Asset Pricing/Theoretical AP/cards/正态-正态更新 - 常数漂移学习#核心推导]]
...
相关卡片：[Asset Pricing/Theoretical AP/cards/OU 滤波 - Riccati 方程](Asset Pricing/Theoretical AP/cards/OU 滤波 - Riccati 方程)

**说明：- 点击展开：OU 滤波卡片**
![[Asset Pricing/Theoretical AP/cards/OU 滤波 - Riccati 方程#核心推导]]
...
相关卡片：[Asset Pricing/Theoretical AP/cards/异质信念 - 创新布朗运动与状态价格密度](Asset Pricing/Theoretical AP/cards/异质信念 - 创新布朗运动与状态价格密度)

**说明：- 点击展开：信念差异 / 状态价格密度卡片**
![[Asset Pricing/Theoretical AP/cards/异质信念 - 创新布朗运动与状态价格密度#核心推导]]
...
延伸卡片：[Asset Pricing/Theoretical AP/cards/异质信念 - 创新布朗运动与状态价格密度](Asset Pricing/Theoretical AP/cards/异质信念 - 创新布朗运动与状态价格密度)
